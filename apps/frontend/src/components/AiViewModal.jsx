                            ...
                            <div className="px-4 pt-5 pb-4">
                                ...
                                <div className="grid grid-cols-2 gap-10 m-10">
                                    <div className="col-span-1 h-96 bg-blue-100 rounded-xl text-white flex items-center justify-center">
                                        <DonutChart progress={3} radiusChart={175} strokeChart={75} />
                                    </div>
                                    <div className="col-span-1 bg-blue-900 text-white rounded-xl">
                                        <div className="flex p-4 items-center">
                                            <div className="pt-3 self-center">
                                                <svg width="97" height="97" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M64.0352 59.0146C62.2543 59.0146 60.8145 60.4545 60.8145 62.2354C60.8145 64.0162 62.2543 65.4561 64.0352 65.4561C65.816 65.4561 67.2559 64.0162 67.2559 62.2354C67.2559 60.4545 65.816 59.0146 64.0352 59.0146ZM83.3594 15.9141H63.2773C63.2773 12.987 60.8997 10.6094 57.9727 10.6094H50.3945C47.4675 10.6094 45.0898 12.987 45.0898 15.9141H25.0078C23.3312 15.9141 21.9766 17.2687 21.9766 18.9453V37.8906H13.6406C11.964 37.8906 10.6094 39.2452 10.6094 40.9219V83.3594C10.6094 85.036 11.964 86.3906 13.6406 86.3906H45.4688C47.1454 86.3906 48.5 85.036 48.5 83.3594V81.8438H83.3594C85.036 81.8438 86.3906 80.4892 86.3906 78.8125V18.9453C86.3906 17.2687 85.036 15.9141 83.3594 15.9141ZM42.4375 80.3281H16.6719V58.3516H42.4375V80.3281ZM42.4375 52.2891H16.6719V43.9531H42.4375V52.2891ZM44.332 26.5234V21.9766H51.1523V16.6719H57.2148V21.9766H64.0352V26.5234H44.332ZM61.3828 42.4375V47.7422C61.3828 48.159 61.0418 48.5 60.625 48.5H56.0781C55.6613 48.5 55.3203 48.159 55.3203 47.7422V42.4375C55.3203 42.0207 55.6613 41.6797 56.0781 41.6797H60.625C61.0418 41.6797 61.3828 42.0207 61.3828 42.4375ZM64.0352 70.9502C59.223 70.9502 55.3203 67.0475 55.3203 62.2354C55.3203 57.4232 59.223 53.5205 64.0352 53.5205C68.8473 53.5205 72.75 57.4232 72.75 62.2354C72.75 67.0475 68.8473 70.9502 64.0352 70.9502ZM72.75 47.7422C72.75 48.159 72.409 48.5 71.9922 48.5H67.4453C67.0285 48.5 66.6875 48.159 66.6875 47.7422V38.6484C66.6875 38.2316 67.0285 37.8906 67.4453 37.8906H71.9922C72.409 37.8906 72.75 38.2316 72.75 38.6484V47.7422ZM64.0352 53.5205C59.223 53.5205 55.3203 57.4232 55.3203 62.2354C55.3203 67.0475 59.223 70.9502 64.0352 70.9502C68.8473 70.9502 72.75 67.0475 72.75 62.2354C72.75 57.4232 68.8473 53.5205 64.0352 53.5205ZM64.0352 65.4561C62.2543 65.4561 60.8145 64.0162 60.8145 62.2354C60.8145 60.4545 62.2543 59.0146 64.0352 59.0146C65.816 59.0146 67.2559 60.4545 67.2559 62.2354C67.2559 64.0162 65.816 65.4561 64.0352 65.4561Z" fill="#EEEEEC" />
                                                </svg>
                                            </div>

                                            <h2 className="text-5xl self-center ms-4">In Process</h2>
                                        </div>
                                        <p className="text-3xl p-8">Text here</p>
                                    </div>
                                </div>
