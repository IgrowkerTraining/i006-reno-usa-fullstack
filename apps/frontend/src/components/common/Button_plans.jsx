...
export const ButtonPlans = ({ name, projectId, planUrl: initialPlanUrl, projectManagerId, onPlanUpdate }) => {
    ...
    const PaperclipIcon = () => (
        <svg
            ...
            className="w-5 h-5 mr-2 stroke-[#0A1F61]"
            viewBox="0 0 24 24"
            fill="none"
            strokeWidth="2.2"
            strokeLinecap="round"
    ...
    return (
        <div className="flex justify-end items-center px-3 py-4 hover:scale-95 transition-transform duration-300">
            <button
                ...
                command="show-modal"
                commandfor="Plans"
                className="bg-blue-900 text-white hover:bg-blue-600 py-2 px-4 rounded w-40 h-10 flex items-center justify-center"
            >
                Plans
            </button>
                            ...
                            <div className="px-4 pt-5 pb-4">
                                ...
                                <div className="mt-4 flex justify-center items-center min-h-[400px]">
                                    {currentPlanUrl ? (
                                        ...
                                        <p className="text-gray-500 italic text-lg mt-4">
                                            No project plan available yet.
                                        </p>
                                    )}
                                </div>
                            </div>
